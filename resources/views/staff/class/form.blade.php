...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="block">
            ...
            @endif
            <form action="{{ $model->exists ? route('lecture.update',$model->id) : route('lecture.store')}}" method="post" class="">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="dob" name="dob" class="form-control input-datepicker" data-date-format="yyyy/mm/dd" value="{{old('dob',$model->dob)}}" placeholder="Click me to choose lecture dob" readonly="" required="">
